...
var server = require('http').createServer(function(req, res) {  
    ...
    switch(host){     
        case 'localhost':
            //将从 localhost:80 发出的请求转接到 http://127.0.0.1:7001
            proxy.web(req, res, { target: 'http://127.0.0.1:7001' });  //真实的请求地址
            break;
        case '127.0.0.1':
            //将从 127.0.0.1:80 发出的请求转接到 http://127.0.0.1:7001
            proxy.web(req, res, { target: 'http://127.0.0.1:7001' });//真实请求地址
            break;
        case 'aaaa.com':
        case 'bbs.aaaa.com':
